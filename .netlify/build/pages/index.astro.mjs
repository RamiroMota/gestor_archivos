...
import { FileQuestion, Archive, Music, Video, Presentation, FileSpreadsheet, FileText, Image, FileCheck2, Folder, Lock, X, Eye, AlertTriangle, HardDrive, ShieldCheck, Database, Search, RefreshCw, ArrowLeft, ChevronRight, Grid, List, FolderPlus, Clock } from 'lucide-react';
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es" class="dark"> <head><meta charset="UTF-8"><meta name="description" content="TeraBox Lite - Explorador de archivos moderno y seguro con Modo Lectura Estricto"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title><!-- Fuentes Premium de Google Fonts --><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Outfit:wght@400;500;600;700&display=swap" rel="stylesheet">${renderHead()}</head> <body class="bg-slate-950 text-slate-100 antialiased overflow-hidden"> ${renderSlot($$result, $$slots["default"])} </body></html>`;
...
function PreviewModal({ item, onClose }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fade-in", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-4xl bg-slate-900/90 rounded-2xl border border-slate-700/50 shadow-2xl overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-6 py-4 bg-slate-950/40 border-t border-slate-800 text-xs text-slate-400", children: [
      ...
      /* @__PURE__ */ jsx("p", { children: "© 2026 TeraBox Clone - Modo Lectura Protegido" })
    ] })
  ] }) });
}
...
function FileExplorer() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex h-screen bg-slate-950 text-slate-100 font-sans overflow-hidden", children: [
    /* @__PURE__ */ jsxs("aside", { className: "w-64 bg-slate-900/40 border-r border-slate-800/80 p-5 flex flex-col justify-between hidden md:flex backdrop-blur-md", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-8 px-2", children: [
          /* @__PURE__ */ jsx("div", { className: "w-10 h-10 bg-brand-500 rounded-xl flex items-center justify-center text-white font-bold shadow-lg shadow-brand-500/20", children: "TB" }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "font-bold text-lg leading-tight tracking-wide bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent", children: "TeraBox" }),
            /* @__PURE__ */ jsx("span", { className: "text-xs text-brand-400 font-medium", children: "Clon Minimalista" })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-slate-800/30 border border-slate-700/20 rounded-2xl p-4 backdrop-blur-sm", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-xs text-slate-400 mb-2", children: [
          /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx(Database, { className: "w-3.5 h-3.5 text-brand-400" }),
            " Almacenamiento Nube"
          ] }),
          /* @__PURE__ */ jsx("span", { className: "font-semibold text-slate-200", children: "1.2 GB / 1 TB" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "w-full bg-slate-800 rounded-full h-2 overflow-hidden mb-1", children: /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-brand-500 to-cyan-400 h-2 rounded-full", style: { width: "0.12%" } }) }),
        /* @__PURE__ */ jsx("p", { className: "text-[10px] text-slate-500 text-right", children: "0.12% Usado" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("main", { className: "flex-1 flex flex-col overflow-hidden", children: [
      /* @__PURE__ */ jsxs("header", { className: "h-16 border-b border-slate-800/80 px-6 flex items-center justify-between bg-slate-900/20 backdrop-blur", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "h-8 w-[1px] bg-slate-800" }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-xs text-slate-300 font-medium hidden sm:inline", children: "Usuario de Prueba" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto p-6 space-y-6", children: [
        ...
        loading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-64 space-y-4", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4", children: filteredItems.map((item) => {
            ...
            return /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: `aspect-square w-full rounded-xl ${styles.bg} flex items-center justify-center mb-3 transition-colors duration-300 border border-transparent group-hover:border-slate-800 overflow-hidden relative`, children: [
                    ...
                    !isFolder && /* @__PURE__ */ jsx("div", { className: "absolute bottom-2 right-2 p-1.5 bg-slate-950/80 backdrop-blur rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 border border-slate-800", children: /* @__PURE__ */ jsx(Eye, { className: "w-3.5 h-3.5 text-brand-400" }) })
                  ] }),
          ...
          // VISTA EN LISTA
          /* @__PURE__ */ jsx("div", { className: "bg-slate-900/10 border border-slate-850 rounded-2xl overflow-hidden shadow-xl", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
            /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b border-slate-800/80 bg-slate-950/40 text-slate-400 text-xs font-semibold", children: [
            ...
            /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-slate-800/40", children: filteredItems.map((item) => {
              const type = getFileType(item.mimeType, item.name);
              const Icon = getFileIcon(type);
              const styles = getFileTypeStyles(type);
              const isFolder = type === "folder";
                ...
                "tr",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("td", { className: "p-4 flex items-center gap-3", children: [
                      /* @__PURE__ */ jsx("div", { className: `p-2.5 rounded-lg ${styles.bg} border border-transparent group-hover:border-slate-800/50`, children: /* @__PURE__ */ jsx(Icon, { className: `w-4 h-4 ${styles.text}` }) }),
